...
- Personajes: imágenes realistas animadas con Kling 3.0 sobre pantalla verde (15 animaciones: reposo triste, mirar atrás,
  caminar, correr, saltar, empujar, jalar, trepar, caer, desplomarse, arrodillarse a llorar, ofrecer la rosa; ella: reposo,
  caminar, recibir la rosa), convertidas en sprite sheets con
  `tools/make_sheets.py` y luego en siluetas estilo LIMBO (cuerpo negro, un ojo blanco, la rosa roja) con
